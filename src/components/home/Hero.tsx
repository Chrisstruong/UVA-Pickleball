        ...
        <section className="mx-auto grid max-w-7xl items-center gap-12 px-6 py-20 md:grid-cols-2">
            <div>
                ...
                <div className="mt-8 flex flex-wrap gap-4">
                    <Button asChild className="bg-orange-600 px-8 py-6 font-bold uppercase hover:bg-orange-700">
                        <Link href="/contact">Join Club</Link>
                    </Button>

                    <Button asChild variant="outline" className="px-8 py-6 font-bold uppercase">
