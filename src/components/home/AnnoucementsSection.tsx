    ...
    <section className="bg-white">
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-16 lg:py-20">
        <div className="mb-8 flex flex-col gap-5 sm:mb-10 sm:flex-row sm:items-end sm:justify-between">
          ...
          <Link
            href="/announcements"
            className="font-heading inline-flex w-fit items-center gap-2 border border-[#E57200] px-4 py-2.5 text-xs font-bold uppercase tracking-wider text-[#E57200] transition hover:bg-[#E57200] hover:text-white sm:px-5 sm:py-3"
          >
            View All Updates
            <span>→</span>
          </Link>
            ...
            >
              ...
              <div className="mt-4">
                ...
                <div className="mt-2 flex items-center gap-2 text-sm text-muted-foreground">
                  <CalendarDays className="h-4 w-4 shrink-0 text-[#E57200]" />
                  <p>Posted on {item.publishedAt}</p>
                </div>
